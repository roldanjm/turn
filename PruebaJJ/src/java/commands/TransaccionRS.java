...
public class TransaccionRS {
    ...
    public boolean altaObjeto(Object objeto) {
        ...
        System.out.println("Tamaño: " + atributos.length);
        ...
        for (int i = 0; i <= atributos.length - 1; i++) {
            try {
                ...
                } else if (tipo.equals("Integer") == true || tipo.equals("int") == true || tipo.equalsIgnoreCase("float") == true || tipo.equals("double") == true) {
                    try {
                        Object valor = getter.invoke(objeto, new Object[0]);
                        query.append(valor);
                    } catch (IllegalAccessException ex) {
